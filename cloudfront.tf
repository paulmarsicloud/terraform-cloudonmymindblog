resource "aws_cloudfront_distribution" "www_distribution" {
  origin {
    ...
    origin_id   = "www.thecloudonmymind.com"
  }
  ...
  default_cache_behavior {
    ...
    target_origin_id       = "www.thecloudonmymind.com"
    min_ttl                = 0
    default_ttl            = 86400
    max_ttl                = 31536000
  ...
  aliases = ["www.thecloudonmymind.com"]
...
resource "aws_cloudfront_distribution" "redirect_distribution" {
  origin {
    ...
    origin_id   = "thecloudonmymind.com"
  }
  ...
  default_cache_behavior {
    ...
    allowed_methods        = ["GET", "HEAD"]
    cached_methods         = ["GET", "HEAD"]
    target_origin_id       = "thecloudonmymind.com"
    min_ttl                = 0
    default_ttl            = 86400
    max_ttl                = 31536000
